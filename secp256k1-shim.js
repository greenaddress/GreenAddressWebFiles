...
module.exports = {
  ...
  _secp256k1_context_randomize: function () { return window.Module._secp256k1_context_randomize.apply(window.Module, arguments); },
  _secp256k1_ec_pubkey_create: function () { return window.Module._secp256k1_ec_pubkey_create.apply(window.Module, arguments); },
  _secp256k1_ec_pubkey_parse: function () { return window.Module._secp256k1_ec_pubkey_parse.apply(window.Module, arguments); },
  _secp256k1_ec_pubkey_serialize: function () { return window.Module._secp256k1_ec_pubkey_serialize.apply(window.Module, arguments); },
  _secp256k1_ecdh: function () { return window.Module._secp256k1_ecdh.apply(window.Module, arguments); },
  _secp256k1_ecdsa_sign: function () { return window.Module._secp256k1_ecdsa_sign.apply(window.Module, arguments); },
  _secp256k1_ecdsa_signature_parse_der: function () { return window.Module._secp256k1_ecdsa_signature_parse_der.apply(window.Module, arguments); },
  _secp256k1_ecdsa_signature_serialize_der: function () { return window.Module._secp256k1_ecdsa_signature_serialize_der.apply(window.Module, arguments); },
  _secp256k1_ecdsa_verify: function () { return window.Module._secp256k1_ecdsa_verify.apply(window.Module, arguments); },
