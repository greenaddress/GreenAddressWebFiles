...
cp build/static/js/btchip-js-api/api/{ByteString,Convert,GlobalConstants}.js WalletCordova/www/greenaddress.it/static/js/btchip-js-api/api
cp -r build/static/js/btchip-js-api/thirdparty/{async,class,q} WalletCordova/www/greenaddress.it/static/js/btchip-js-api/thirdparty
