...
var ChromeapiPlugupCardTerminal = require('./ChromeapiPlugupCardTerminal');
var chromeDevice = require('./chromeDevice');

var ChromeapiPlugupCardTerminalFactory = module.exports = Class.extend(CardTerminalFactory, {
